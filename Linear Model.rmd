...
Since the P-value 4.99e-06 is less than .05 so we reject the null hypothesis and accept the alternative. There is a difference between Model 1 and Model 3. The Residual signs of squares is lower on Model 3 than on Model 1 so we can tell Model 3 is a better fit than Model 1. 